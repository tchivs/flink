...
import io.confluent.flink.formats.avro.registry.converters.AvroToRowDataConverters;
import io.confluent.flink.formats.avro.registry.utils.MutableByteArrayInputStream;
...
public class AvroRegistryDeserializationSchema implements DeserializationSchema<RowData> {
    ...
    private transient AvroToRowDataConverters.AvroToRowDataConverter runtimeConverter;
