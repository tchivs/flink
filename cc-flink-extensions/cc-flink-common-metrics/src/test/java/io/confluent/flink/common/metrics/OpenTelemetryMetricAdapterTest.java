...
/** Tests for {@link io.confluent.flink.common.metrics.OpenTelemetryMetricAdapter}. */
public class OpenTelemetryMetricAdapterTest {

    private static final CollectionMetadata METADATA =
            new CollectionMetadata(Resource.create(Attributes.empty()), 123L, 345L);
