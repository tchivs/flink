...
public class PineconeInputFormatter extends JsonObjectInputFormatter {
    ...
    static List<Schema.UnresolvedColumn> getPineconeInputColumns(
        ...
        LogicalType topKType = RemoteRuntimeUtils.getLogicalType(inputColumns.get(0));
        ...
        LogicalType vectorType = RemoteRuntimeUtils.getLogicalType(inputColumns.get(1));
        ...
        unresolvedColumns.add(
                new Schema.UnresolvedPhysicalColumn(
                        "topK", RemoteRuntimeUtils.getAbstractType(inputColumns.get(0))));
        unresolvedColumns.add(
                new Schema.UnresolvedPhysicalColumn(
                        "vector", RemoteRuntimeUtils.getAbstractType(inputColumns.get(1))));
