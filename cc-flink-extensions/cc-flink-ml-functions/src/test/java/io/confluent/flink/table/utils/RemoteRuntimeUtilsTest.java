...
/** Tests for RemoteRuntimeUtil class. */
public class RemoteRuntimeUtilsTest {
    ...
    public void testGetLogicalType(DataType resolvedType) {
        ...
        LogicalType parsedLogicalType = RemoteRuntimeUtils.getLogicalType(column);
    ...
    public void testDecryptWithComputePoolKey() throws Exception {
        ...
        assertThat(RemoteRuntimeUtils.decryptSecretWithComputePoolKey(encryptedSecret, decrypter))
                .isEqualTo(PLAINTEXT);
    }
    ...
    public void testSignData() throws Exception {
        ...
        final CredentialDecrypter decrypter =
                new MockedInMemoryCredentialDecrypterImpl(keyPair.getPrivate().getEncoded());
        final byte[] signature = RemoteRuntimeUtils.signData(data, decrypter);
