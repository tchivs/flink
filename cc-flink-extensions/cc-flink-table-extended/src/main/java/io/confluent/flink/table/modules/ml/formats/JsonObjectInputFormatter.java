...
public class JsonObjectInputFormatter implements InputFormatter {
    ...
    public JsonObjectInputFormatter(
            List<Schema.UnresolvedColumn> inputColumns, String objectWrapper) {
    ...
    public JsonObjectInputFormatter(List<Schema.UnresolvedColumn> inputColumns) {
    ...
    public byte[] format(Object[] args) {
        ...
        final ObjectNode wrap = objectWrapper != null ? mapper.createObjectNode() : node;
