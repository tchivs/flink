...
public class ScalarFunctionHandlerTest {
    ...
    public void testNoMatchingFunction() {
        Assertions.assertTrue(
                assertThrows(
                        ...
                        .getMessage()
                        .contains("Table program cannot be compiled"));
    }
    ...
    public static class IdentityScalarFunction extends ScalarFunction {
        public StringData eval(StringData argument) {
            return argument;
        }
    ...
    public static class NoMatchingScalarFunction extends ScalarFunction {
        public StringData eval(int argument) {
            return StringData.fromString(String.valueOf(argument));
        }
    }
}
